                            ...
                            <div class="res-banner-search-block row">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                    ...
                                    <form id="veg_check_form">
                                        ...
                                        <label class="form-check-label " for="veg-check">Pure Veg</label>
                                        </form>
                                    </div>
                                </div>
                                    ...
                                    <div class="res-banner-search input-group search-box">
                                            ...
                                            <!-- <div class="input-group"> -->
                                                ...
                                                <input type="text" name="prodname" class="form-control" placeholder="Search for dishes"><i class="ion-android-close search-close"></i>
