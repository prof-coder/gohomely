        ...
        <div class="container">
          <div class="food-section row js-restaurant-wrapper" id="filter-menu">
            ...
            <div class="food-sec-right col-md-9 col-sm-8 col-xs-12">
              ...
              <div class="res-filter-list-section" id="treditions">
              ...
              <!-- Restaurant Filter List Starts -->
              <div class="res-filter-list-section" id="famous">
                <!-- Restaurant Filter Head Starts -->
                <div class="res-filter-list-head">
                  <h5>Famous</h5>
                </div>
              ...
              <div class="res-filter-list-section" id="offers">
                ...
                @forelse(@$Offers as $Shop)
                  ...
                  @endif
                    <div class="food-img bg-img" style="background-image: url({{$Shop->avatar}});"></div>
                    <div class="food-details">
                      <h6 class="food-det-tit">{{$Shop->name}}
                        <span class="food-rating"><i class="ion-android-star"></i> {{$Shop->rating}}</span>
                      </h6>
                      <p class="food-det-txt">{{$Shop->description}}</p>
                      <div class="food-other-details row">
                        ...
                        <div class="col-xs-12">
                          <span class="food-deliver-time food-list-txt">Delivery Time: {{$Shop->estimated_delivery_time}}Mins</span>
                        </div>
                         <!--  <div class="col-xs-6 text-right">
                          <span class="food-quantity-price food-list-txt">$100 for two</span>
                        </div> -->
              ...
              <!-- Restaurant Filter List Ends -->
              <!-- Restaurant Filter List Starts -->
              <div class="res-filter-list-section" id="trending">
                <!-- Restaurant Filter Head Starts -->
                <div class="res-filter-list-head">
                  <h5>Trending</h5>
                </div>
        ...
        <div class="container-fluid">
          ...
          <div class="all-res-list-inner">
            <div class="all-res-head row m-0">
              <div class="all-res-head-left col-md-4 p-0">
                <h4 class="all-res-head-tit"> Displaying Homechefs near you</h4>
              </div>
                      ...
                      <div class="food-other-details row">
                        <div class="col-xs-12">
                          <span class="food-deliver-time food-list-txt">
                            Delivery Time: {{$Shop->estimated_delivery_time}}Mins</span>
                        </div>
                         <!--  <div class="col-xs-6 text-right">
                          <span class="food-quantity-price food-list-txt">$100 for two</span>
                        </div> -->
