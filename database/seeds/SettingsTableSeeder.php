...
class SettingsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('settings')->insert([
            ...
            [
                'key' => 'APP_STORE_LINK',
                'value' => 'https://itunes.apple.com/us/app/foodbox-express-food-delivery/id1296870125?mt=8'
            ],
            [
                'key' => 'GOOGLE_PLAY_LINK',
                'value' => 'https://play.google.com/store/apps/details?id=com.foodbox.app&hl=en'
            ],
